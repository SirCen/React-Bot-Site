...
export default function Navbar() {
    ...
    return (
        ...
        <div>
          <nav class="bg-gray-700 shadow-2xl">
                ...
                <div class="flex items-center">
                  ...
                  <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                      <a href="/" class="text-gray-300  hover:text-green-300 px-3 py-2 rounded-md text-sm font-medium">About</a>
        
                      <a href="/" class="text-gray-300  hover:text-green-300 px-3 py-2 rounded-md text-sm font-medium">Invite</a>
        
                      <a href="/" class="text-gray-300  hover:text-green-300 px-3 py-2 rounded-md text-sm font-medium">Commands</a>
